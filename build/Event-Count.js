...
const VISIBLE_CALENDARS = ["Work", "Family"];
...
counterstack.addText(String(itemsToShow.length)).font = Font.boldSystemFont(25);
counterstack.addSpacer();
widget.url = "calshow://";
if (config.runsInApp) widget.presentMedium();else if (config.runsInWidget) Script.setWidget(widget);